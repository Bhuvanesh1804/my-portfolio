...
// Typing Animation
const typingTexts = [
    'Frontend Developer | Java | Machine Learning',
    'Building clean and scalable applications',
    'Aspiring AI/ML/DL Engineer, currently pursuing B.Tech at Kalasalingam Academy of Research and Education',
...
downloadResumeBtn.addEventListener('click', (e) => {
    ...
    setTimeout(() => {
        ...
        link.href = 'C:\Users\sanku\Downloads\Sanku_Bhuvanesh_resume (3).pdf'; // Replace with actual resume file path
        link.download = 'Bhuvanesh_Resume.pdf';
        link.click();
    }, 1000);
});
...
console.log('%c🚀 Welcome to Bhuvanesh\'s Portfolio!', 'font-size: 20px; font-weight: bold; color: #3b82f6;');
